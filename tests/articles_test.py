...
class TestArticles(unittest.TestCase):
    ...
    def setUp(self):
        self.new_article = Articles('Koinange', 'No human is limited', 'Kipchoge runs a marathon in less than 2 hours',
                                    'https://bing.com', 'https://bing.com/images', '2019-10-12T11:31:03Z')
    ...
    def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_article.description,
                          'Kipchoge runs a marathon in less than 2 hours')
